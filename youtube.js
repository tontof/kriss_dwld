...
(function(){
    ...
    /* from deturl */
    function Ok(a){a=a.split("");a=Pk(a,32);a=a.reverse();a=a.slice(3);a=a.reverse();a=a.slice(1);a=a.reverse();a=Pk(a,19);a=Pk(a,24);a=a.slice(3);return a.join("")}
    function Pk(a,b){var c=a[0];a[0]=a[b%a.length];a[b]=c;return a};
    function ytSig(d){return Ok(d);}
